...
$queryUPD = "UPDATE books SET views = $cnt WHERE book_id = $book_id";
$mysqli->query($queryUPD);
...
<main>
    <div class="container container_book">
        <div class="row">
            <div class="col-md-4">
                <img class="featurette-image img-fluid book_img mx-auto"
                     src="../books/books_img/<?php echo $book['img'] ?>">
                <!--
                ...
                <?php
                if (isset($user_id)) {
                    if (isset($_GET['book_added_to_favourite']) && $_GET['book_added_to_favourite'] == 1) {
            ...
            <div class="col-md-8">
                <div class="container container_book_describe">
                    ...
                    if (file_exists('books/books_audio/' . $book['text'] . '.mp3')) { ?>
                                    ...
                                    <div class="audio green-audio-player">
                                        ...
                                        <div class="play-pause-btn">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20"
                                                 viewBox="0 0 18 24">
                                                <path fill="#363636" fill-rule="evenodd" d="M18 12L0 24V0"
                                        ...
                                        <div class="volume">
                                            <div class="volume-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20"
                                                     viewBox="0 0 24 24">
                                                    <path fill="#363636" fill-rule="evenodd"
                                        ...
                                        <audio crossorigin>
                                            <?php
                                            echo '<source src="books/books_audio/'. $book['text'] . '.mp3">';
                                            ?>
                                        </audio>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="dropdown">
                                <button class="dropbtn">
                                    <span class="icon fa fa-cloud"></span> Скачать
                                </button>
