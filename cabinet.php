...
<main>
    <div class="container container_user">
        <?php
        if (isset($_GET['book_was_successfully_added']) && $_GET['book_was_successfully_added'] == 1) {
        ...
        <div class="row">
            ...
            <div class="col-md-5" style="justify-content: center; text-align: center;">
                <div class="avatar">
                    <img class="rounded-circle" src="images/avatars/<?php echo $user['avatar']; ?>" width="190"
                         height="190">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item <?php if ($_GET['page'] == 'settings') {
                                ...
                                <a class="nav-link"
                                   href="cabinet.php?page=settings">Настройки&nbsp<strong>⚙</strong></a>
                            </li>
                        </ul>
                    </div>
                </nav>
    ...
    <ul class="hs">';
        ...
        <div class="row" style="background-color: #fff8e7; border-radius: 12px; padding: 2em; margin-top: 2em;">
            <p>Вы можете <a href="add_book.php" class="book_add_icon">добавить свою книгу или книгу, которой ещё нет</a>
                в нашей библиотеке</p>
