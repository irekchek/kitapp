...
<header>
        <nav class="navbar navbar-expand-xl navbar-light fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item <?php if(isset($index)) echo 'active'; ?>
                               ">
                        <a class="nav-link" href="index.php">Главная</a>
                    </li>
                    <li class="nav-item <?php if(isset($recommend)) echo 'active'; ?>
                               ">
                        <a class="nav-link" href="recommendations.php">Рекомендации</a>
                    </li>
                    <li class="nav-item <?php if(isset($genres)) echo 'active'; ?>">
                        <a class="nav-link" href="genres.php">Жанры</a>
                    </li>
                    <li class="nav-item <?php if(isset($authors)) echo 'active'; ?>">
                        <a class="nav-link" href="authors.php">Авторы</a>
                    </li>
                    <li class="nav-item <?php if(isset($about_us)) echo 'active'; ?>">
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-1RT5WMFT1Y"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-1RT5WMFT1Y');
        </script>
    </header>